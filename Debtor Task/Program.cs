...
//var list = debtors.Where(x => x.Email.Contains("rhyta.com") || x.Email.Contains("dayrep.com"));
...
//var list = debtors.Where(x => x.Debt > 5000);
//foreach (var item in list)
//{
//    Console.WriteLine(item);
//}
...
//var list = debtors.Where(x => x.FullName.Length> 18 || (x.Phone.Length > 2 && x.Phone.Length < 7));
//foreach (var item in list)
//{
//    Console.WriteLine(item);
//}
...
//var list = debtors.Where(x => x.BirthDay.Month.ToString() == "December" || x.BirthDay.Month.ToString() == "January" || x.BirthDay.Month.ToString() == "February");
//foreach (var item in list)
//{
//    Console.WriteLine(item);
//}
...
//var list = debtors.Where(x => x.Phone.Contains("8") != true);
//foreach (var item in list)
//{
...
//var list = debtors.OrderByDescending(x => x.Debt).Take(5);
//foreach (var item in list)
//{
//    Console.WriteLine(item);
//}
